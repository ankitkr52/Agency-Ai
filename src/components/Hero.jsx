    ...
    return (
        <div id='hero' className='flex flex-col items-center gap-6 py-20 px-4 sm:px-12 lg:px-24 xl:px-40 text-center w-full overflow-hidden text-gray-700 dark:text-white'>
            ...
            <motion.h1
                ...
                viewport={{ once: true }}
                className='text-4xl sm:text-5xl md:text-6xl xl:text-[84px] font-medium xl:leading-tight max-w-5xl'>Turning imagination into <span className='bg-gradient-to-r from-blue-600 via-blue-400 to-[#4d8cea] bg-clip-text text-transparent'>Digital</span>impact</motion.h1>
            <motion.p
