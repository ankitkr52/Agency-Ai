...
const ContactUs = () => {
    return (
        <motion.div
            ...
            viewport={{ once: true }}
            id='contact-us' className='flex flex-col items-center gap-7 px:4 sm:px-12 lg:px-24 xl:px-40 pt-32 text-gray-800 dark:text-white'>
            ...
            <motion.form
                ...
                viewport={{ once: true }}
                onSubmit={onSubmit} className='grid sm:grid-cols-2  gap-3  max-w-2xl w-full' >
